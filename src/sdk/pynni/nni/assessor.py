...
class Assessor(Recoverable):
    ...
    def load_checkpoint(self):
        ...
        _logger.debug('Load checkpoint ignored by assessor, checkpoint path: %s', checkpoin_path)
    ...
    def save_checkpoint(self):
        ...
        """
        checkpoin_path = self.get_checkpoint_path()
        _logger.debug('Save checkpoint ignored by assessor, checkpoint path: %s', checkpoin_path)
